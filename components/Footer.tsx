        ...
        <div className="grid md:grid-cols-4 gap-12">
          ...
          <div className="md:col-span-1">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-semibold">Econexus</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/services#biodiversity" className="text-gray-400 hover:text-white transition text-sm">
                  Biodiversity Sampling
                </Link>
              </li>
              <li>
                <Link href="/services#digitaltwin" className="text-gray-400 hover:text-white transition text-sm">
                  Digital Twin
                </Link>
              </li>
              <li>
                <Link href="/services#edna" className="text-gray-400 hover:text-white transition text-sm">
                  eDNA Analysis
                </Link>
              </li>
              <li>
        ...
        <div className="max-w-7xl mx-auto px-6 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-gray-500 text-sm">
              &copy; {new Date().getFullYear()} Econexus Foundation. All rights reserved.
            </p>
            <div className="flex items-center space-x-6 text-sm">
              ...
              <span className="text-gray-500">
                When nature is valued, it gets protected. When it&apos;s measured, it gets funded.
              </span>
            </div>
          </div>
        </div>
